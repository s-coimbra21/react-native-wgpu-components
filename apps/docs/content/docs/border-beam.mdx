...
<ComponentPreview
  preview={<BorderBeamBasic />}
  code={`import { BorderBeam } from 'react-native-wgpu-components';
...
<ComponentPreview
  preview={<BorderBeamModes />}
  code={`<BorderBeam mode="aura" colors="colorful" />
<BorderBeam mode="line" colors="colorful" />`}
  dark
/>
...
<ComponentPreview
  preview={<BorderBeamFollowCursor />}
  code={`<BorderBeam followCursor colors="ocean" borderRadius={16}>
  <View>...</View>
</BorderBeam>`}
  dark
/>
